...
import main.java.server.logic.handler.InputHandler;
import main.java.server.logic.handler.model.Client;
import main.java.server.logic.handler.model.ServerOutput;
...
public class LibServer implements Runnable{
	...
	public void start() {
		if (thread == null) {
			...
			StudentTabel.getInstance();
			CourseTabel.getInstance();
